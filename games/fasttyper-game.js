...
class fastTyper {
    ...
    startGame(msg) {
        ...
        .setColor("#960202")
        .setTitle(`Hızlı Daktilo`)
        .setDescription(`**Bir kelime seçiliyor...**
        Oyunlar 5 saniye içinde başlıyor...
        Oyunlar 4 saniye içinde başlıyor...
        Oyunlar 3 saniye içinde başlıyor...
        Oyunlar 2 saniye içinde başlıyor...
        Oyunlar 1 saniye içinde başlıyor...
        Kelimedir...`)
        .setTimestamp()
        ...
        Oyunlar 1 saniye içinde başlıyor...
                ...
                **GG!**
                **Kazanan ${collected.first().author}**`)
                .setTimestamp()
                ...
                .setColor("#960202")
                .setTitle(`Hızlı Daktilo`)
                .setDescription(`**Kelimeyi doğru yazmak için geç kaldınız!**`)
                .setTimestamp()
