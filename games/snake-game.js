...
class SnakeGame {
    ...
    startGame(msg) {
        ...
        .setColor('#03ad03')
        .setTitle(`Yılan Oyunu - ${msg.author.username}`)
        ...
        msg.channel.send(embed).then(gameMessage => {
            ...
            .catch(collected => {
                ...
                .setColor("#03ad03")
                .setTitle(`Oyun bitti - ${msg.author.username}`)
                .setDescription(`**Bir süre tepki vermedin!**
                **Toplam Tutulan Elmalar: **${score}`)
                .setTimestamp()
            ...
            const gameOver = () => {
                ...
                .setColor("#03ad03")
                .setTitle(`Oyun bitti - ${msg.author.username}`)
                .setDescription(`**Toplam Tutulan Elmalar: **${score}`)
                .setTimestamp()
                gameMessage.edit(editEmbed)
